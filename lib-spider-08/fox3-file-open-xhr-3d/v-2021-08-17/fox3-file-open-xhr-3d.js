...
FOX.onHashChange = function () {
	...
	if ( FOX.extension === "xml" || FOX.extension === "gbxml" ) {
		...
		if ( FOX.gbxmlParser === undefined ) {

			FOX.gbxmlParser = document.body.appendChild( document.createElement( 'script' ) );
			FOX.gbxmlParser.onload = () => GBX.onChange( fileName );
			FOX.gbxmlParser.src = COR.path + "lib-spider-08/parsers/v-2021-08-17/gbx-gbxml-parser.js";
