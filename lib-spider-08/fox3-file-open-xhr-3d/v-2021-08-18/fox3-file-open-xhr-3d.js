...
FOX.onHashChange = function () {
	...
	if ( FOX.extension === "3dm" ) {
		...
		if ( COR.r3dmParser === undefined ) {
			...
			COR.r3dmParser.onload = () => r3DM.init( fileName );
			COR.r3dmParser.src = COR.path + "lib-spider/3dm-parser/v-2021-08-18/3dm-parser.js";
	...
	if ( FOX.extension === "xml" || FOX.extension === "gbxml" ) {
		...
		if ( COR.gbxmlParser === undefined ) {
			...
			COR.gbxmlParser.onload = () => GBX.onChange( fileName );
			COR.gbxmlParser.src = COR.path + "lib-spider-08/parsers/v-2021-08-18/gbx-gbxml-parser.js";
	...
	if ( FOX.extension === "hbjson" ) {
		...
		if ( FOX.hbjsonParser === undefined ) {
			...
			FOX.hbjsonParser.src = COR.path + "lib-spider-08/parsers/v-2021-08-17/hbj-hbjson-parser.js";
	...
	if ( FOX.extension === "rad" ) {
		...
		if ( FOX.radParser === undefined ) {
			...
			FOX.radParser.onload = () => RAD.init( fileName );
			FOX.radParser.src = COR.path + "lib-spider/rad-parser/v-2021-08-16/rad-parser.js";
