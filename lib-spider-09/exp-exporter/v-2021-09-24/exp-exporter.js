...
EXP.init = function () {
	...
	const htm = `
			...
			<details>
				...
				Exporters
				${ MNU.addInfoBox( "Save models in a variety of file formats. More formats will be added. Also: create an animated GIF. Learn about other online viewers<br><br>version: v-2021-09-02" ) }
				</summary>
...
EXP.loadGGF = function () {
	...
	scr = document.body.appendChild( document.createElement( 'script' ) );
	scr.src = "https://www.ladybug.tools/spider-2021/lib-spider-09/exp-exporter/v-2021-09-03/ggf-generate-gif.js";
