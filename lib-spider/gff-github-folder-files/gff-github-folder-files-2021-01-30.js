...
const GFF = {
	...
	source: "https://www.ladybug.tools/spider-2021/spider-viewer/lib-spider/gff-github-folder-files/gff-multiple.js"
...
GFF.getGithubFoldersFiles = function ( index, items ) {
	...
	//GFF.folders = GFF[ items ];

	// console.log( "GFF.folders ", GFF.folders, items   );
